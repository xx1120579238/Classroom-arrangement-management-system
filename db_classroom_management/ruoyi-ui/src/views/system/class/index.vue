<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="教室类型" prop="cKind">
        <el-input
          v-model="queryParams.cKind"
          placeholder="请输入教室类型"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="容纳人数" prop="cSeat">
        <el-input
          v-model="queryParams.cSeat"
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="教室类型" align="center" prop="cKind" />
      <el-table-column label="最大容纳人数" align="center" prop="cSeat" />
      <el-table-column label="教室状态" align="center" prop="cStatus" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="教室类型" prop="cKind">
          <el-input v-model="form.cKind" placeholder="请输入教室类型" />
        </el-form-item>
        <el-form-item label="最大容纳人数" prop="cSeat">
          <el-input v-model="form.cSeat" placeholder="请输入最大容纳人数" />
        </el-form-item>
        <el-form-item label="教室状态" prop="cStatus">
          <el-input v-model="form.cStatus" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cSeat: [
          { required: true, message: "最大容纳人数不能为空", trigger: "blur" }
        ],
        cStatus: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除教室管理编号为"' + cIds + '"的数据项？').then(function() {
